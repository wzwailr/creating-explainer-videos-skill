...
> Superseded by v2.0.1. This tag predates later Python packaging fixes, and its Node.js 18+ claim is incompatible with the pinned HyperFrames 0.8.15 renderer. Use v2.0.1 for installation and verification; v2.0.0 remains unchanged as historical release evidence.
