...
REQUIRED_WHEEL_FILES = {
    "creating_explainer_videos_skill/__init__.py": "__version__ = '2.0.0'\n",
    ...
    "creating_explainer_videos_skill-2.0.0.dist-info/METADATA": "Name: creating-explainer-videos-skill\nVersion: 2.0.0\n",
    "creating_explainer_videos_skill-2.0.0.dist-info/entry_points.txt": (
...
class DistributionAuditTests(unittest.TestCase):
    ...
    def test_accepts_wheel_with_runtime_skill_and_three_templates(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary:
            wheel = Path(temporary) / "creating_explainer_videos_skill-2.0.0-py3-none-any.whl"
